...
Проект на этапе архитектурного каркаса. Основной pipeline все еще работает на заглушках, но добавлен отдельный рабочий MVP-сценарий реального импорта 1 товара в Ozon Seller API.
